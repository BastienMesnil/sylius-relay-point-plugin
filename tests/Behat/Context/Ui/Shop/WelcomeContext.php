...
namespace Tests\BastienMesnil\SyliusRelayPointPlugin\Behat\Context\Ui\Shop;

use Behat\Behat\Context\Context;
use Tests\BastienMesnil\SyliusRelayPointPlugin\Behat\Page\Shop\WelcomePageInterface;
