...
namespace BastienMesnil\SyliusRelayPointPlugin\Controller;
...
final class GreetingController extends AbstractController
{
    ...
    {
        return $this->render(
            '@BastienMesnilSyliusRelayPointPlugin/shop/greeting/static.html.twig',
    ...
    {
        return $this->render(
            '@BastienMesnilSyliusRelayPointPlugin/shop/greeting/dynamic.html.twig',
            ['greeting' => $this->getGreeting($name)],
        );
    }
